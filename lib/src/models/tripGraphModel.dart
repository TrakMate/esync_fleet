class TripGraphModel {
  ...
  int? todayDistanceKm;
  int? todayOperationalHours;
  int? yesterdayDistanceKm;
  int? yesterdayOperationalHours;
  ...
  TripGraphModel.fromJson(Map<String, dynamic> json) {
    if (json['groups'] != null) {
      groups = <Groups>[];
    ...
    todayOperationalHours = json['todayOperationalHours'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['todayOperationalHours'] = this.todayOperationalHours;
