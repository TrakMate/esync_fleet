...
class DeviceReportView extends StatefulWidget {
  final String title;
  final String description;
  const DeviceReportView({
    super.key,
    required this.title,
  ...
  @override
  State<DeviceReportView> createState() => _DeviceReportViewState();
}

class _DeviceReportViewState extends State<DeviceReportView> {
  DateTime? fromDate;
  DateTime? toDate;
