...
class DetailedTripsReportView extends StatefulWidget {
  final String title;
  final String description;
  const DetailedTripsReportView({
    super.key,
    required this.title,
  ...
  @override
  State<DetailedTripsReportView> createState() =>
      _DetailedTripsReportViewState();
}

class _DetailedTripsReportViewState extends State<DetailedTripsReportView> {
  DateTime? fromDate;
  DateTime? toDate;
          ...
          optionsViewBuilder: (context, onSelected, options) {
            return Align(
              ...
              child: Material(
                ...
                child: Container(
                  decoration: BoxDecoration(
                    color: isDark ? tBlack : tWhite, // ✅ same as dropdown
                    boxShadow: [
                      BoxShadow(
                        spreadRadius: 2,
                        blurRadius: 10,
                  ...
                  child: ConstrainedBox(
                    ...
                    child: ListView.builder(
                      padding: EdgeInsets.zero, // ✅ same as dropdown
                      shrinkWrap: true,
